...
{
    public partial class AddDatabaseOfAllModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProdutoImagemURL = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioId = table.Column<int>(type: "int", nullable: false),
                    UsarioId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
